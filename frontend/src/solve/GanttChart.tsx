...
export function GanttChart({ schedule, machines, jobNames, operationNames }: GanttChartProps) {
      ...
      >
        ...
        {layout.map((bar) => (
          <GanttBar
            ...
            operationLabel={
              operationNames?.[bar.jobIndex]?.[bar.operationIndex]?.trim() ||
              `operation ${bar.operationIndex + 1}`
            }
